<script setup>
const { data, refresh } = await useFetch("/api/receipt-settings");
...
<template>
  <div>
    ...
    <p style="font-size: 13.5px; color: #8a909b; margin: 6px 0 24px;">Customize what appears on printed receipts.</p>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 18px; max-width: 760px;">
      ...
      <div class="rs-card">
        ...
        <div v-if="error" style="color:#e36b6b; font-size:12.5px; margin-top:10px;">{{ error }}</div>
